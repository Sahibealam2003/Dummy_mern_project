                    ...
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        <div className="rounded-2xl border border-[#ede8e2] bg-white p-5 md:p-6 shadow-sm space-y-4">
                            <h3 className="text-sm font-bold uppercase tracking-wider text-[#2c2420] border-b border-[#f5f3ef] pb-2.5">
                                <svg className="h-5 w-5 inline-block mr-2 text-[#e8622a]" width="800px" height="800px" viewBox="-5.25 0 50 50" xmlns="http://www.w3.org/2000/svg"><g id="Group_19" data-name="Group 19" transform="translate(-1219.44 -717.022)"><path id="Path_50" data-name="Path 50" d="M1256.94,765.022h-35.5v-46h21.25l14.25,15.75Z" fill="#ffffff" stroke="#231f20" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" /><path id="Path_51" data-name="Path 51" d="M1241.69,720.022v14.75h14.25" fill="#d1d3d4" stroke="#231f20" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" /><line id="Line_28" data-name="Line 28" x2="20.75" transform="translate(1227.69 757.272)" fill="none" stroke="#231f20" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" /><line id="Line_29" data-name="Line 29" x2="10.75" transform="translate(1227.69 749.272)" fill="none" stroke="#231f20" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" /></g></svg> Order Summary
                            </h3>
