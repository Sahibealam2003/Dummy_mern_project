...
const FIELD_CLS =
  "w-full rounded-xl border border-[#e4dfd9] bg-[#fafafa] px-4 py-2 text-sm text-[#2c2420] placeholder-[#a69c93] outline-none focus:bg-[#fafafa] focus:border-[#e8622a] focus:ring-4 focus:ring-[#e8622a]/10 transition-all duration-200";
const LABEL_CLS =
  "block text-xs font-semibold uppercase tracking-wider text-[#8c7e74] mb-1.5";
...
const Checkout = ({ onHideFooter, onShowFooter }) => {
      ...
      <div className="mx-auto max-w-2xl px-4 py-8 text-center animate-scale-in">
        ...
        <div className="mb-8 max-w-md mx-auto">
          <div className="flex items-center justify-between relative">
            ...
            <div className="flex flex-col items-center gap-1.5 bg-[#f5f3ef] px-3.5">
              ...
              <span className="text-[9px] font-black uppercase tracking-wider text-[#2c2420]">
                Confirmation
              </span>
            </div>
          </div>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-[#ede8e2] bg-white p-8 md:p-12 shadow-md">
          ...
          <div className="relative mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-emerald-50 text-emerald-600 shadow-inner mb-6">
            <svg
              className="h-10 w-10 text-emerald-600 animate-pulse"
              fill="none"
              stroke="currentColor"
              strokeWidth="2.5"
              viewBox="0 0 24 24"
            ...
            <span
              className="absolute -top-1 -right-3 animate-bounce"
          ...
          <p className="mt-2 text-sm text-[#8c7e74] max-w-md mx-auto">
            Your order has been placed successfully. A confirmation receipt has
            been sent to{" "}
            <span className="font-semibold text-[#2c2420]">
              {orderSummarySnapshot.email}
            </span>
            .
          </p>
          ...
          <div className="my-8 rounded-2xl border border-dashed border-[#ede8e2] bg-[#fdfbf9] p-6 text-left space-y-4 shadow-sm">
            ...
            <div className="flex justify-between items-center border-b border-[#f5f3ef] pb-3">
              <div>
                <span className="text-xs font-semibold uppercase tracking-wider text-[#8c7e74] block">
                  Order ID
                </span>
                <span className="font-mono font-bold text-sm text-[#2c2420]">
                  {orderNumber}
                </span>
              </div>
              <button
              ...
              >
                {copied ? (
                  ...
                  <>
                    <svg
                      className="w-3.5 h-3.5 text-[#8c7e74]"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2"
                      viewBox="0 0 24 24"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#8c7e74] block mb-0.5">
                  Shipping Destination
                </span>
                <p className="font-semibold text-[#2c2420]">
                  {orderSummarySnapshot.name}
                </p>
                <p className="text-[#8c7e74] leading-relaxed mt-0.5">
                  {orderSummarySnapshot.address}
                  <br />
              ...
              <div>
                ...
                <span className="text-[10px] text-[#8c7e74] block mt-1">
                  Standard Delivery (
                  {orderSummarySnapshot.shipping === 0
                    ? "Free"
                    : `$${orderSummarySnapshot.shipping.toFixed(2)}`}
                  )
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs border-t border-[#f5f3ef] pt-3">
              ...
              <div>
                ...
                <span className="text-base font-bold text-[#e8622a]">
                  ${orderSummarySnapshot.finalTotal.toFixed(2)}
                </span>
              </div>
            </div>
            ...
            <div className="border-t border-[#f5f3ef] pt-4">
              <span className="text-[10px] font-bold uppercase tracking-wider text-[#8c7e74] block mb-3">
              ...
              <div className="relative flex justify-between items-center max-w-md mx-auto pt-2 pb-1">
                ...
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  <span className="text-[8px] font-black uppercase tracking-wider text-[#2c2420]">
                    Ordered
                  </span>
                </div>
            ...
            <div className="border-t border-[#f5f3ef] pt-3">
              <span className="text-[10px] font-bold uppercase tracking-wider text-[#8c7e74] block mb-2">
                Items Purchased
              </span>
                ...
                {orderSummarySnapshot.items.map((item) => (
                  ...
                  >
                    <span className="text-[#2c2420] font-medium truncate max-w-[280px]">
                      {item.title}{" "}
                      <span className="text-[#8c7e74] text-[10px] font-normal ml-1">
                        x{item.quantity}
                      </span>
                    </span>
                    <span className="font-semibold text-[#8c7e74] shrink-0">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <button
              ...
              className="flex-1 px-2 inline-flex items-center justify-center rounded-xl bg-[#2c2420] text-sm font-bold text-white shadow-lg hover:bg-[#3d3028] active:scale-[0.99] transition-all cursor-not-allowed opacity-50"
            >
              Download Invoice
            </button>
            <Link
    ...
    return (
      <div className="mx-auto max-w-md px-4 py-32 text-center animate-fade-in">
        <div className="flex flex-col items-center gap-5">
          <svg
            className="h-12 w-12 animate-spin-slow text-[#e8622a]"
            fill="none"
            viewBox="0 0 24 24"
          >
            <circle
    ...
    return (
      <div className="mx-auto max-w-xl px-4 py-16 text-center animate-fade-in-up">
        <div className="rounded-3xl border border-[#ede8e2] bg-white p-12 shadow-sm">
          <svg
            className="h-16 w-16 mx-auto text-[#8c7e74] mb-4 opacity-40"
            viewBox="0 0 24 24"
          ...
          <h2 className="text-xl font-bold text-[#2c2420]">
            Your cart is empty
          </h2>
          <p className="mt-1 text-sm text-[#8c7e74] max-w-xs mx-auto">
            Add some high-quality items to your shopping cart to complete your
            checkout.
          </p>
          <Link
            to="/"
  ...
  const isFreeShipPromoActive =
    promoApplied && appliedPromoCode === "FREESHIP" && totalPrice >= 25;
  ...
  const handlePlaceOrder = async (e) => {
    ...
    try {
      ...
      const snapshot = {
        ...
        paymentMethod:
          paymentMode === "Offline" ? "Cash on Delivery" : "Online",
      ...
      const data = await createPaymentOrderApi(finalTotal);
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          if (verify.success) {
            ...
            setOrderNumber(order.order?.orderNumber);

            setCreatedOrder(order.order);

            setOrderSummarySnapshot((prev) => ({
              ...prev,
              cardLastFour: response.razorpay_payment_id
                ? response.razorpay_payment_id.slice(-4)
                : "••••",
    ...
    <div style={{ background: "#f5f3ef", minHeight: "100vh" }}>
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8 animate-fade-in">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-[#8c7e74] mt-0.5">
        ...
        <div className="mb-8 max-w-md mx-auto animate-fade-in-up">
          <div className="flex items-center justify-between relative">
            ...
            <div className="flex flex-col items-center gap-1.5 bg-[#f5f3ef] px-3.5">
              ...
              <span className="text-[9px] font-black uppercase tracking-wider text-[#8c7e74]">
                Payment
              </span>
            </div>
            ...
            <div className="rounded-2xl border border-[#ede8e2] bg-white p-5 md:p-6 space-y-4 shadow-sm">
              <div className="flex justify-between items-center border-b border-[#f5f3ef] pb-2.5 mb-1">
                <h3 className="text-sm font-bold uppercase tracking-wider text-[#2c2420] flex items-center">
                  <svg
                    className="h-5 w-5 inline-block mr-2 text-[#e8622a]"
                    width="24px"
                    height="24px"
                    viewBox="0 0 24 24"
                    xmlns="<http://www.w3.org/2000/svg>"
                  ...
                  >
                    ...
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 002 2h2a2.5 2.5 0 002.5-2.5V10a2 2 0 00-2-2h-1.07a2 2 0 01-1.414-.586l-2.828-2.828A2 2 0 009.586 4H8z"
                      />
                    </svg>
              ...
              {paymentMode === "Online" ? (
                <div className="rounded-xl border border-orange-100 bg-orange-50/20 p-4 animate-scale-in flex gap-3 items-start">
                  ...
                  <div className="text-xs space-y-1">
                    <h4 className="font-bold text-[#2c2420]">
                      Pay Securely via Razorpay
                    </h4>
                    <p className="text-[#8c7e74] leading-relaxed">
                      Clicking "Place Order" will open Razorpay's secure
                      checkout gateway overlay. You can pay seamlessly using{" "}
                      <strong>
                        UPI, Cards (Visa, Mastercard, RuPay), Netbanking, or
                        Wallets
                      </strong>
                      .
                    </p>
                ...
                <div className="rounded-xl border border-stone-200 bg-stone-50/40 p-4 animate-scale-in flex gap-3 items-start">
                  ...
                  <div className="text-xs space-y-1">
                    ...
                    <p className="text-[#8c7e74] leading-relaxed font-medium">
                      Your order will be processed. You can pay with cash or
                      digitial scanner apps at the time of delivery.
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="rounded-2xl border border-[#ede8e2] bg-white p-5 md:p-6 shadow-sm space-y-4">
              <h3 className="text-sm font-bold uppercase tracking-wider text-[#2c2420] border-b border-[#f5f3ef] pb-2.5">
                <svg
                  ...
                  width="800px"
                  height="800px"
                  viewBox="-5.25 0 50 50"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g
                    id="Group_19"
                    data-name="Group 19"
                    transform="translate(-1219.44 -717.022)"
                  >
                    <path
                      id="Path_50"
                      data-name="Path 50"
                      d="M1256.94,765.022h-35.5v-46h21.25l14.25,15.75Z"
                      fill="#ffffff"
                      stroke="#231f20"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    ...
                    <path
                      id="Path_51"
                      data-name="Path 51"
                      d="M1241.69,720.022v14.75h14.25"
                      fill="#d1d3d4"
                      stroke="#231f20"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    ...
                    <line
                      ...
                      data-name="Line 28"
                      x2="20.75"
                      transform="translate(1227.69 757.272)"
                      fill="none"
                      stroke="#231f20"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    ...
                    <line
                      ...
                      data-name="Line 29"
                      x2="10.75"
                      transform="translate(1227.69 749.272)"
                      fill="none"
                      stroke="#231f20"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="font-semibold text-[#2c2420] truncate">
                        {item.title}
                      </p>
                      <p className="text-[#8c7e74] mt-0.5">
              ...
              {promoApplied && (
                <p className="text-[10px] font-bold text-emerald-600 mt-2">
                  ✓ {appliedPromoCode} Code Applied ({appliedPromoDiscountText}{" "}
                  Discount)!
                </p>
              )}
              {promoError && (
              ...
              {offers.length > 0 && (
                <div className="space-y-2 mt-4 pt-4 border-t border-[#ede8e2]">
                  <span className="text-[10px] font-black uppercase tracking-wider text-[#8c7e74] block">
                    Available Offers (Click to Apply)
                  </span>
                  <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-thin">
                    {offers.map((offer) => {
                      const activeOffer =
                        promoApplied && appliedPromoCode === offer.code;
                      return (
                        <div
                          key={offer._id}
                        ...
                        >
                          ...
                          <h4 className="text-[11px] font-bold text-[#2c2420] mt-2 truncate">
                            {offer.title}
                          </h4>
                          <p className="text-[9px] text-[#8c7e74] mt-0.5 line-clamp-2 leading-relaxed">
                            {offer.description}
                          </p>
                          <span className="text-[10px] font-bold text-[#e8622a] mt-1.5 block">
                            {offer.discount} OFF
                          </span>
                        </div>
                      );
